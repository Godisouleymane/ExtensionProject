    ...
    function displayFavorites() {
        ...
        chrome.storage.local.get("favorites", function (result) {
            ...
            for (const favorite of favorites) {
                ...
                // Ajoutez un gestionnaire d'événements pour ouvrir le lien dans un nouvel onglet
                link.addEventListener("click", function (e) {
                    e.preventDefault(); // Empêche le lien de naviguer vers l'URL
                    chrome.tabs.create({ url: favorite }); // Ouvre le lien dans un nouvel onglet
                });
